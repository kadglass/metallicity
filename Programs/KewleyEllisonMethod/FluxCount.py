...
def count(galaxy, sigma_4363):
	...
	Conditions: must be emission line; [OIII] 4363 has minimum sigma_4363 
	detection.'''
	...
	C = {'index':galaxy['index'], 'I06':1, 'pyNeb':1}
	...
	#
	############################################################################
	# Restrictions: all fluxes > 0, [OIII] 4363 > sigma_4363
	...
	return C, flag_3727, flag_NH, flag_NeH, StoN, flag_SII, SIIratio, flag_OIII, OIIIratio
